...
class Magic(Hero):
    ...
    def apply_super_power(self, boss, heroes):
        ...
        for hero in heroes:
            ...
            print(f'{self.name} BOSST AND IMUNITE.')
...
def start_game():
    boss = Boss(name='Madara', health=500, damage=50)
    warrior_1 = Warrior(name='Naruto', health=420, damage=50)
    warrior_2 = Warrior(name='Saske', health=390, damage=30)
    magic = Magic(name='Kakashi', health=290, damage=10)
    berserk = Berserk(name='maito gai', health=300, damage=5)
    doc = Medic(name='Sunade', health=270, damage=15, heal_points=20)
    assistant = Medic(name='Sakura', health=300, damage=9, heal_points=15)
